...
export function checkForAtSignMentions(text, minMatchLength): MentionMatch | null {
...
export function getPossibleMentionMatch(text): MentionMatch | null {
...
export function getMentionsTextToSearch(editor: LexicalEditor): string | null {
  let text = null;
