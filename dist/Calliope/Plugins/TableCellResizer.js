...
import { $getNearestNodeFromDOMNode, $getSelection, $isGridSelection, COMMAND_PRIORITY_HIGH, SELECTION_CHANGE_COMMAND, } from 'lexical';
...
function TableCellResizer({ editor }) {
    ...
    return (_jsx("div", { ref: resizerRef, children: activeCell != null && !isSelectingGrid && (_jsxs(_Fragment, { children: [_jsx("div", { className: "TableCellResizer__resizer TableCellResizer__ui", style: resizerStyles.right, onMouseDown: toggleResize('right'), onMouseUp: toggleResize('right') }), _jsx("div", { className: "TableCellResizer__resizer TableCellResizer__ui", style: resizerStyles.bottom, onMouseDown: toggleResize('bottom'), onMouseUp: toggleResize('bottom') })] })) }));
}
export default function TableCellResizerPlugin() {
    const [editor] = useLexicalComposerContext();
    return useMemo(() => createPortal(_jsx(TableCellResizer, { editor: editor }), document.body), [editor]);
}
